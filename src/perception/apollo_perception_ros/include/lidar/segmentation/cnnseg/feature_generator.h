...
#ifndef _APOLLO_PERCEPTION_STANDALONE_LIDAR_CNN_SEGMENTATION_FEATURE_GENERATOR_H_  // NOLINT
#define _APOLLO_PERCEPTION_STANDALONE_LIDAR_CNN_SEGMENTATION_FEATURE_GENERATOR_H_  // NOLINT
...
class FeatureGenerator {
 public:
  ...
  void Generate(apollo_perception_standalone::pcl_util::PointCloudConstPtr pc_ptr);
