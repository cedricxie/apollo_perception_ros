...
#ifndef _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_DST_EVIDENCE_INITIATOR_H_  // NOLINT
#define _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_DST_EVIDENCE_INITIATOR_H_  // NOLINT
...
#include "fusion/probabilistic_fusion/dst_evidence.h"
 ...
 private:
  ...
  DSTInitiator() {
    ...
    _subset_names = {"PEDESTRIAN",       "BICYCLE", "VEHICLE", "OTHERS_MOVABLE",
                     "OTHERS_UNMOVABLE", "OTHERS",  "UNKNOWN"};
    _typ_to_hyp_map = {
        {(size_t)ObjectType::PEDESTRIAN, PEDESTRIAN},
        {(size_t)ObjectType::BICYCLE, BICYCLE},
        {(size_t)ObjectType::VEHICLE, VEHICLE},
        {(size_t)ObjectType::UNKNOWN_MOVABLE, OTHERS_MOVABLE},
        {(size_t)ObjectType::UNKNOWN_UNMOVABLE, OTHERS_UNMOVABLE},
        {(size_t)ObjectType::UNKNOWN, OTHERS},
    };
    // note: others and unkown hyp types are mapping to unkown object type
    _hyp_to_typ_map = {{PEDESTRIAN, (size_t)ObjectType::PEDESTRIAN},
                       {BICYCLE, (size_t)ObjectType::BICYCLE},
                       {VEHICLE, (size_t)ObjectType::VEHICLE},
                       {OTHERS_MOVABLE, (size_t)ObjectType::UNKNOWN_MOVABLE},
                       {OTHERS_UNMOVABLE, (size_t)ObjectType::UNKNOWN_UNMOVABLE},
                       {OTHERS, (size_t)ObjectType::UNKNOWN},
                       {UNKNOWN, (size_t)ObjectType::UNKNOWN}};
  }
