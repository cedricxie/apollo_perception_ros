...
#ifndef _APOLLO_PERCEPTION_STANDALONE_LIDAR_TRACKER_HM_TRACKER_H_
#define _APOLLO_PERCEPTION_STANDALONE_LIDAR_TRACKER_HM_TRACKER_H_
...
#include "lidar/proto/tracker_config.pb.h"

#include "common/object.h"

#include "lidar/tracker/base_matcher.h"
#include "lidar/tracker/object_track.h"
#include "lidar/tracker/tracked_object.h"
...
class HmObjectTracker {
 public:
  ...
  bool Init(std::string &file_path_hm_tracker_config);
