...
#ifndef _APOLLO_PERCEPTION_STANDALONE_COMMON_OBJECT_H_
#define _APOLLO_PERCEPTION_STANDALONE_COMMON_OBJECT_H_
...
struct alignas(16) Object {
  ...
  // fusion status
  bool fused_lidar = false;
  bool fused_radar = false;
  bool fused_cam = false;
...
struct SensorObjects {
  ...
  //LaneObjectsPtr lane_objects; // removed for now
