...
#ifndef _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_PBF_TRACK_H_
#define _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_PBF_TRACK_H_
...
#include "fusion/probabilistic_fusion/dst_evidence_initiator.h"
#include "fusion/probabilistic_fusion/pbf_base_motion_fusion.h"
...
class PbfTrack {
 public:
  explicit PbfTrack(std::shared_ptr<PbfSensorObject> obj, bool log_fusion);
  ...
  static double GetMinRadarConfidentDistance() {
    return s_min_radar_confident_distance_;
  }
  ...
  void SetFusedLidarStatus(bool fused_lidar);
  void SetFusedRadarStatus(bool fused_radar);
  void SetFusedCamStatus(bool fused_cam);
