...
#ifndef _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_PBF_SENSOR_OBJECT_H_  // NOLINT
#define _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_PBF_SENSOR_OBJECT_H_  // NOLINT
