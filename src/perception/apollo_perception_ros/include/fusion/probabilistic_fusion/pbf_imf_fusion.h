...
#ifndef _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_IMF_FUSION_H_  // NOLINT
#define _APOLLO_PERCEPTION_STANDALONE_FUSION_PROBABILISTIC_FUSION_IMF_FUSION_H_  // NOLINT
...
class PbfIMFFusion : public PbfBaseMotionFusion {
 public:
  ...
  void setLogFusionIMF(bool log_fusion_imf) {
      log_fusion_imf_ = log_fusion_imf;
  }
 protected:
