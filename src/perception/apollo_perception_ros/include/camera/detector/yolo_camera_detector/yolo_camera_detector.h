...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_DETECTOR_YOLO_CAMERA_DETECTOR_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_DETECTOR_YOLO_CAMERA_DETECTOR_H_
...
#include "cuda_util/network.h"
#include "cuda_util/region_output.h"
...
#include "camera/common/cnn_adapter.h"
#include "camera/common/projector.h"
#include "camera/dummy/dummy_algorithms.h"
#include "camera/detector/common/feature_extractor.h"
...
class YoloCameraDetector : public BaseCameraDetector {
 public:
  ...
  bool Init(std::string &file_path_config, const CameraDetectorInitOptions &options =
