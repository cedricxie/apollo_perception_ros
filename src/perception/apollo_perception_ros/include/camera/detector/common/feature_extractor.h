...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_DETECTOR_COMMON_FEATURE_EXTRACTOR_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_DETECTOR_COMMON_FEATURE_EXTRACTOR_H_
