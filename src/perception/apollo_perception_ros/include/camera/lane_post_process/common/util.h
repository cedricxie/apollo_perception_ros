...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_LANE_POST_PROCESS_COMMON_UTIL_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_LANE_POST_PROCESS_COMMON_UTIL_H_
