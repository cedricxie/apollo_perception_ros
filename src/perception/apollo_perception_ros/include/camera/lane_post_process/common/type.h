...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_LANE_POST_PROCESS_COMMON_TYPE_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_LANE_POST_PROCESS_COMMON_TYPE_H_
...
#include "camera/lane_post_process/common/base_type.h"
