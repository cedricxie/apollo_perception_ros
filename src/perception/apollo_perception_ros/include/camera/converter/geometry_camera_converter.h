...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_CONVERTER_GEOMETRY_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_CONVERTER_GEOMETRY_H_
...
class GeometryCameraConverter : public BaseCameraConverter {
 public:
  ...
  bool Init(std::string &file_path_config);
