...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_FILTER_OBJECT_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_FILTER_OBJECT_H_
 ...
 private:
  class ObjectFilter {
   public:
    ...
    math::KalmanFilter<float, 2, 1, 1> x_;
    math::KalmanFilter<float, 2, 1, 1> y_;
    math::KalmanFilter<float, 2, 1, 1> theta_;
  ...
  void InitFilter(const float x,
                  math::KalmanFilter<float, 2, 1, 1>* filter);
