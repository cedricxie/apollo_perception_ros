...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_FILTER_OBJECT_CAMERA_KALMAN_FILTER_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_FILTER_OBJECT_CAMERA_KALMAN_FILTER_H_
...
#include "util/extended_kalman_filter.h"
 ...
 public:
  ...
  class ObjectFilter {
   public:
    ...
    math::ExtendedKalmanFilter<float, 4, 3, 1> object_config_filter_;
  };
