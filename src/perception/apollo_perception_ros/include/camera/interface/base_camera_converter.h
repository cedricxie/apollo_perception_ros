...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_INTERFACE_BASE_CAMERA_CONVERTER_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_INTERFACE_BASE_CAMERA_CONVERTER_H_
