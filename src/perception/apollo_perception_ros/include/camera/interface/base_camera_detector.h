...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_INTERFACE_BASE_CAMERA_DETECTOR_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_INTERFACE_BASE_CAMERA_DETECTOR_H_
...
class BaseCameraDetector {
 public:
  ...
  virtual bool Lanetask(const cv::Mat& frame,
