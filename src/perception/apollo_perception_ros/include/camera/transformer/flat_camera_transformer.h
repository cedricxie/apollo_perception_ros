...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_TRANSFORMER_FLAT_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_TRANSFORMER_FLAT_H_
...
class FlatCameraTransformer : public BaseCameraTransformer {
 public:
  ...
  bool Transform(std::vector<std::shared_ptr<VisualObject>> *objects, 
