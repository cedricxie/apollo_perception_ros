...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_TRACKER_KCF_AFFINITY_TRACKER_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_TRACKER_KCF_AFFINITY_TRACKER_H_
...
#include "camera/tracker/kcf/kcf_components.h"
