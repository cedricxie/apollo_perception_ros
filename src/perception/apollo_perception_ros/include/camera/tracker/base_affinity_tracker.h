...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_TRACKER_BASE_AFFINITY_TRACKER_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_TRACKER_BASE_AFFINITY_TRACKER_H_
