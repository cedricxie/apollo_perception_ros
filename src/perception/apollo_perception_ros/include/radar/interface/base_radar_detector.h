...
#ifndef _APOLLO_PERCEPTION_STANDALONE_RADAR_INTERFACE_RADAR_DETECTOR_H_
#define _APOLLO_PERCEPTION_STANDALONE_RADAR_INTERFACE_RADAR_DETECTOR_H_
...
using apollo_perception_standalone::Header;
using apollo_perception_standalone::conti_radar::ContiRadarObs;
using apollo_perception_standalone::conti_radar::ContiRadar;
...
class BaseRadarDetector {
 public:
  ...
  virtual bool Init(std::string &path_config_folder) = 0;
