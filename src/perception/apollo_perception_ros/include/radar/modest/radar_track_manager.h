...
#ifndef _APOLLO_PERCEPTION_STANDALONE_RADAR_MODEST_RADAR_TRACK_MANAGER_H_
#define _APOLLO_PERCEPTION_STANDALONE_RADAR_MODEST_RADAR_TRACK_MANAGER_H_
...
class RadarTrackManager {
 public:
  RadarTrackManager(bool log_radar) {log_radar_ = log_radar;}
  ~RadarTrackManager() {}
