...
#ifndef _APOLLO_PERCEPTION_STANDALONE_RADAR_MODEST_CONTI_RADAR_UTIL_H_
#define _APOLLO_PERCEPTION_STANDALONE_RADAR_MODEST_CONTI_RADAR_UTIL_H_
 ...
 public:
  ...
  static bool IsConflict(const Eigen::Vector3f& main_velocity,
    ...
    if (vector_temp1.head(2).norm() > velocity_threshold &&
      ...
      double theta = util::VectorTheta2dXy(vector_temp1, vector_temp2);
