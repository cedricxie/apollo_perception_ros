...
#ifndef _APOLLO_PERCEPTION_STANDALONE_CAMERA_DETECTOR_REGION_OUTPUT_H_
#define _APOLLO_PERCEPTION_STANDALONE_CAMERA_DETECTOR_REGION_OUTPUT_H_
...
#include "cuda_util/util.h"  // NOLINT
